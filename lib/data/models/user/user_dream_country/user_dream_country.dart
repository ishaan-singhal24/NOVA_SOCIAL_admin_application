...
part 'user_dream_country.freezed.dart';
part 'user_dream_country.g.dart';

@freezed
class UserDreamCountry
    with _$UserDreamCountry
    implements GlobalDocHelperInterface, DreamInterface {
  @Implements<GlobalDocHelperInterface>()
  @Implements<DreamInterface>()
  const factory UserDreamCountry({
    String? id,
    String? name,
    String? iconUrl,
  ...
  factory UserDreamCountry.fromJson(Map<String, dynamic> json) =>
      _$UserDreamCountryFromJson(json);
}

var dreamCountriesJsonList = [
